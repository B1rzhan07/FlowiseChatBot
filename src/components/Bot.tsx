          ...
          >
            <For each={[...messages()]}>
              {(message, index) => {
                ...
                const notFoundMessageCustom =
                  "Извините, у нас ведутся технические работы. AI учитель скоро возобновит работу...";
                const isLimitTokenMessage = message.message.includes(
                  "org-3QQESijIq5tobeE1sRIaphM4"
                );
                const limitTokenMessage = "Вы превысили количество символов.";
                const isLimitContextMessage = message.message.includes(
                  "This model's maximum context length is"
                );
                const limitContextMessage =
